...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260518130616_NullableInstallationDescriptorFields")]
    partial class NullableInstallationDescriptorFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Entities.Auth.BootstrapTokenEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ConsumedByInstallationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConsumedByInstallationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Infrastructure.Entities.Auth.InstallationApiCredentialEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InstallationApiCredentials");
                });

            modelBuilder.Entity("Infrastructure.Entities.Auth.InstallationEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClientApp", "OsUserId", "MachineId");

                    b.ToTable("Installations");
                });

            modelBuilder.Entity("Infrastructure.Entities.Auth.RegistrationEventEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ClaimedAppVersion")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("ClaimedClientApp")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<Guid?>("ClaimedInstallGuid")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ClaimedMachineId")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("ClaimedOsUserId")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<int?>("ResultingInstallationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResultingInstallationId");

                    b.HasIndex("SourceIp");

                    b.HasIndex("ClaimedClientApp", "OccurredAt");
            ...
            modelBuilder.Entity("Infrastructure.Entities.Auth.BootstrapTokenEntity", b =>
                {
                    b.HasOne("Infrastructure.Entities.Auth.InstallationEntity", "ConsumedByInstallation")
                        .WithOne()
                        .HasForeignKey("Infrastructure.Entities.Auth.BootstrapTokenEntity", "ConsumedByInstallationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ConsumedByInstallation");
                });

            modelBuilder.Entity("Infrastructure.Entities.Auth.InstallationApiCredentialEntity", b =>
                {
                    b.HasOne("Infrastructure.Entities.Auth.InstallationEntity", "Installation")
                        .WithOne("Credential")
                        .HasForeignKey("Infrastructure.Entities.Auth.InstallationApiCredentialEntity", "InstallationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Infrastructure.Entities.Auth.RegistrationEventEntity", b =>
                {
                    b.HasOne("Infrastructure.Entities.Auth.InstallationEntity", "ResultingInstallation")
                        .WithMany()
                        .HasForeignKey("ResultingInstallationId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ResultingInstallation");
                });
